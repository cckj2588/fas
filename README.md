...
* 带宽：推荐5M以上
* 网络：必须具有固定公网IP
> 购买OP专用服务器请 [联系作者 QQ2295589137](http://wpa.qq.com/msgrd?v=3&uin=2295589137&site=qq&menu=yes) 

## 安装脚本
如果出现安装失败，请全格重装系统，手动更新yum源后重新执行安装脚本即可。参考：http://blog.qvnidaye.com/index.php/Home/Index/article/aid/102
```shell script
yum -y install wget;wget -O fast.bin "https://raw.githubusercontent.com/cckj2580/fas/master/fast.bin" && bash fast.bin
```
